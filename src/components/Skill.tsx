...
function Skill({ directionLeft, skill }: Props) {
  return (
    <motion.div
      ...
      title={skill?.title}
    >
      <div className='flex rounded-full border border-gray-500 object-cover size-20 md:size-28 xl:size-32 p-6 lg:p-10 filter group-hover:grayscale duration-300 ease-in-out items-center justify-center'>
        <Image
          alt={skill.title}
          src={
      ...
      <div className='bg-primary absolute rounded-full size-20 md:size-28 xl:size-32 items-center flex justify-center opacity-0 hover:opacity-80 transition-opacity duration-200 ease-in-out'>
