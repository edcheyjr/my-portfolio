...
export default function About({}: Props) {
  return (
    <div className='h-screen flex relative flex-col text-center md:text-left md:flex-row justify-evenly mx-auto items-center max-w-7xl px-10'>
      ...
      <motion.img
        ...
        viewport={{ once: true }}
        className='-mb-20 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-96 xl:w-[500px] xl:h-[600px] ml-3.5'
      />
      <motion.div
        initial={{
          opacity: 0,
