...
function Skill({ directionLeft }: Props) {
  return (
    ...
    >
      <div className='rounded-full border border-gray-500 object-cover w-24 h-24 md:w-28 md:h-28  xl:w-32 xl:h-32 filter group-hover:grayscale duration-300 ease-in-out items-center justify-center flex'>
        <img
          alt='React js'
